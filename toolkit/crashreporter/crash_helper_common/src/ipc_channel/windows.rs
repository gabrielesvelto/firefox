...
use std::{hash::RandomState, process};

use windows_sys::Win32::Foundation::ERROR_ACCESS_DENIED;

use crate::{
    errors::IPCError,
    platform::windows::{get_last_error, server_name},
...
impl IPCChannel {
    ...
    pub fn new() -> Result<IPCChannel, IPCError> {
        ...
        let mut listener = IPCListener::new(server_name(pid))?;
        listener.listen()?;
...
impl IPCClientChannel {
    ...
    fn create_listener() -> Result<IPCListener, IPCError> {
        ...
        for _i in 0..ATTEMPTS {
            ...
            let pipe_name = format!("\\\\.\\pipe\\gecko-crash-helper-child-pipe.{random_id:}\0");
