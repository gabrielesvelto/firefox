                                                    ...
                                                    cairo_linear_pattern_t *pattern)
{
    ...
    if (!SetWorldTransform (surface->win32.dc, &xform)) {
	status = _cairo_win32_print_gdi_error ("_win32_printing_surface_paint_linear_pattern:SetWorldTransform2");
	goto cleanup;
    }
    ...
    {
	status = _cairo_win32_print_gdi_error ("_win32_printing_surface_paint_linear_pattern:GradientFill");
    }
